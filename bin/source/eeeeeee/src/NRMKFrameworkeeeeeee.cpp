 ...
 */
#include "NRMKFrameworkeeeeeee.h"
...
const unsigned int SimulationSocketeeeeeee::_bodyIndexArray[] = { NRMK_BODY_INDEX };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocketeeeeeee::_dataChannelArray[]
...
const unsigned int DataSocketeeeeeee::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
