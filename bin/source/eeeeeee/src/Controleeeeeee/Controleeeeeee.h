...
#define NUM_WAYPOINTS				(eeeeeee::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_eeeeeee.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_eeeeeee.dat"
#endif
...
class Controleeeeeee
{
public:
	enum
	{
		JOINT_DOF = eeeeeee::JOINT_DOF,
	};		

	typedef eeeeeee::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<eeeeeee> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<eeeeeee> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<eeeeeee, TaskKinematics> InverseKinematics;
	
public:
	Controleeeeeee();
	~Controleeeeeee();

  	eeeeeee const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	eeeeeee const & robot() const { return _robot; }
...
private:
	eeeeeee	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<eeeeeee, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<eeeeeee, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
