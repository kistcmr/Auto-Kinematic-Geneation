...
typedef eeeeeee			ROBOT;

#if defined(_CONTROLLER)

#if !defined(_APP_MANAGER)
// Control Algorithm
#include "Controleeeeeee/Controleeeeeee.h"
typedef Controleeeeeee		CONTROLLER;
#endif
...
// Simulation Socket
#include "SimulationSocketeeeeeee.h"
typedef SimulationSocketeeeeeee SIMULATION_SOCKET;

// Data Socket
#include "DataSocketeeeeeee.h"
typedef DataSocketeeeeeee DATA_SOCKET;
...
#if defined(_CONTROL_CLIENT)
// Control graphics 
#include "GraphicsControleeeeeee.h"
typedef GraphicsControleeeeeee GRAPHICS_CONTROL;
#else	// _CONTROL_CLIENT
// Graphics Socket
#include "GraphicsSocketeeeeeee.h"
typedef GraphicsSocketeeeeeee GRAPHICS_SOCKET;
#endif // _CONTROL_CLIENT
