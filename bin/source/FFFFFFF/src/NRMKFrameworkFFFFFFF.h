...
typedef fffffff			ROBOT;

#if defined(_CONTROLLER)

#if !defined(_APP_MANAGER)
// Control Algorithm
#include "Controlfffffff/Controlfffffff.h"
typedef Controlfffffff		CONTROLLER;
#endif
...
// Simulation Socket
#include "SimulationSocketfffffff.h"
typedef SimulationSocketfffffff SIMULATION_SOCKET;

// Data Socket
#include "DataSocketfffffff.h"
typedef DataSocketfffffff DATA_SOCKET;
...
#if defined(_CONTROL_CLIENT)
// Control graphics 
#include "GraphicsControlfffffff.h"
typedef GraphicsControlfffffff GRAPHICS_CONTROL;
#else	// _CONTROL_CLIENT
// Graphics Socket
#include "GraphicsSocketfffffff.h"
typedef GraphicsSocketfffffff GRAPHICS_SOCKET;
#endif // _CONTROL_CLIENT
