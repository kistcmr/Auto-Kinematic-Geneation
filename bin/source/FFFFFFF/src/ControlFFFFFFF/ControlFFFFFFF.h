...
#define NUM_WAYPOINTS				(fffffff::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_fffffff.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_fffffff.dat"
#endif
...
class Controlfffffff
{
public:
	enum
	{
		JOINT_DOF = fffffff::JOINT_DOF,
	};		

	typedef fffffff::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<fffffff> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<fffffff> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<fffffff, TaskKinematics> InverseKinematics;
	
public:
	Controlfffffff();
	~Controlfffffff();

  	fffffff const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	fffffff const & robot() const { return _robot; }
...
private:
	fffffff	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<fffffff, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<fffffff, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
