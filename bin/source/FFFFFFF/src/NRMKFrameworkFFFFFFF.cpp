 ...
 */
#include "NRMKFrameworkfffffff.h"
...
const unsigned int SimulationSocketfffffff::_bodyIndexArray[] = { 0,1,2,3,4,5,6 };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocketfffffff::_dataChannelArray[]
...
const unsigned int DataSocketfffffff::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
