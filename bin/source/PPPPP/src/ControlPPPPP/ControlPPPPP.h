...
#define NUM_WAYPOINTS				(PPPPP::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_PPPPP.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_PPPPP.dat"
#endif
...
public:
	enum
	{
		JOINT_DOF = PPPPP::JOINT_DOF,
	};		

	typedef PPPPP::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<PPPPP> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<PPPPP> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<PPPPP, TaskKinematics> InverseKinematics;
	
public:
	ControlPPPPP();
	~ControlPPPPP();

  	PPPPP const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	PPPPP const & robot() const { return _robot; }
...
private:
	PPPPP	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<PPPPP, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<PPPPP, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
