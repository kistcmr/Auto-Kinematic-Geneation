...
const unsigned int SimulationSocketPPPPP::_bodyIndexArray[] = { NRMK_BODY_INDEX };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocketPPPPP::_dataChannelArray[]
...
const unsigned int DataSocketPPPPP::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
