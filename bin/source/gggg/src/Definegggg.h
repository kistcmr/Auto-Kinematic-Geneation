...
typedef NRMKFoundation::SubsysBase<NRMK_NUMBER_OF_BODIES, NRMK_NUMBER_OF_BODIES - 1, NRMK_NUMBER_OF_BODIES - 1, NRMKFoundation::RigidJoint> Subsys_gggg;

class gggg : public Subsys_gggg
{
public:
