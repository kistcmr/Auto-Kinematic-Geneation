...
const unsigned int SimulationSocketgggg::_bodyIndexArray[] = { NRMK_BODY_INDEX };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocketgggg::_dataChannelArray[]
...
const unsigned int DataSocketgggg::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
