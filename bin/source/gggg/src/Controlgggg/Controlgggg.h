...
#define NUM_WAYPOINTS				(gggg::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_gggg.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_gggg.dat"
#endif
...
public:
	enum
	{
		JOINT_DOF = gggg::JOINT_DOF,
	};		

	typedef gggg::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<gggg> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<gggg> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<gggg, TaskKinematics> InverseKinematics;
	
public:
	Controlgggg();
	~Controlgggg();

  	gggg const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	gggg const & robot() const { return _robot; }
...
private:
	gggg	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<gggg, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<gggg, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
