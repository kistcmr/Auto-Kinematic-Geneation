...
// Control Algorithm
#include "ControlPPP/ControlPPP.h"
typedef ControlPPP		CONTROLLER;
#endif
...
// Simulation Socket
#include "SimulationSocketPPP.h"
typedef SimulationSocketPPP SIMULATION_SOCKET;

// Data Socket
#include "DataSocketPPP.h"
typedef DataSocketPPP DATA_SOCKET;
...
#if defined(_CONTROL_CLIENT)
// Control graphics 
#include "GraphicsControlPPP.h"
typedef GraphicsControlPPP GRAPHICS_CONTROL;
#else	// _CONTROL_CLIENT
// Graphics Socket
#include "GraphicsSocketPPP.h"
typedef GraphicsSocketPPP GRAPHICS_SOCKET;
#endif // _CONTROL_CLIENT
