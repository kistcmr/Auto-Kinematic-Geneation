...
const unsigned int SimulationSocketPPP::_bodyIndexArray[] = { NRMK_BODY_INDEX };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocketPPP::_dataChannelArray[]
...
const unsigned int DataSocketPPP::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
