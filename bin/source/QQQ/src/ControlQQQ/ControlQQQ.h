...
#define NUM_WAYPOINTS				(QQQ::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_QQQ.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_QQQ.dat"
#endif
...
public:
	enum
	{
		JOINT_DOF = QQQ::JOINT_DOF,
	};		

	typedef QQQ::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<QQQ> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<QQQ> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<QQQ, TaskKinematics> InverseKinematics;
	
public:
	ControlQQQ();
	~ControlQQQ();

  	QQQ const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	QQQ const & robot() const { return _robot; }
...
private:
	QQQ	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<QQQ, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<QQQ, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
