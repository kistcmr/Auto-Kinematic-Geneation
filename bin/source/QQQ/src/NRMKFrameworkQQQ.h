...
// Control Algorithm
#include "ControlQQQ/ControlQQQ.h"
typedef ControlQQQ		CONTROLLER;
#endif
...
// Simulation Socket
#include "SimulationSocketQQQ.h"
typedef SimulationSocketQQQ SIMULATION_SOCKET;

// Data Socket
#include "DataSocketQQQ.h"
typedef DataSocketQQQ DATA_SOCKET;
...
#if defined(_CONTROL_CLIENT)
// Control graphics 
#include "GraphicsControlQQQ.h"
typedef GraphicsControlQQQ GRAPHICS_CONTROL;
#else	// _CONTROL_CLIENT
// Graphics Socket
#include "GraphicsSocketQQQ.h"
typedef GraphicsSocketQQQ GRAPHICS_SOCKET;
#endif // _CONTROL_CLIENT
