...
const unsigned int SimulationSocketQQQ::_bodyIndexArray[] = { NRMK_BODY_INDEX };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocketQQQ::_dataChannelArray[]
...
const unsigned int DataSocketQQQ::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
