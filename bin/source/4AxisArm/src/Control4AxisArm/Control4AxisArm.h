...
#define NUM_WAYPOINTS				(4AxisArm::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_4AxisArm.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_4AxisArm.dat"
#endif
...
class Control4AxisArm
{
public:
	enum
	{
		JOINT_DOF = 4AxisArm::JOINT_DOF,
	};		

	typedef 4AxisArm::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<4AxisArm> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<4AxisArm> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<4AxisArm, TaskKinematics> InverseKinematics;
	
public:
	Control4AxisArm();
	~Control4AxisArm();

  	4AxisArm const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	4AxisArm const & robot() const { return _robot; }
...
private:
	4AxisArm	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<4AxisArm, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<4AxisArm, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
