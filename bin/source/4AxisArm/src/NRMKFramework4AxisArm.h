...
typedef 4AxisArm			ROBOT;

#if defined(_CONTROLLER)

#if !defined(_APP_MANAGER)
// Control Algorithm
#include "Control4AxisArm/Control4AxisArm.h"
typedef Control4AxisArm		CONTROLLER;
#endif
...
// Simulation Socket
#include "SimulationSocket4AxisArm.h"
typedef SimulationSocket4AxisArm SIMULATION_SOCKET;

// Data Socket
#include "DataSocket4AxisArm.h"
typedef DataSocket4AxisArm DATA_SOCKET;
...
#if defined(_CONTROL_CLIENT)
// Control graphics 
#include "GraphicsControl4AxisArm.h"
typedef GraphicsControl4AxisArm GRAPHICS_CONTROL;
#else	// _CONTROL_CLIENT
// Graphics Socket
#include "GraphicsSocket4AxisArm.h"
typedef GraphicsSocket4AxisArm GRAPHICS_SOCKET;
#endif // _CONTROL_CLIENT
