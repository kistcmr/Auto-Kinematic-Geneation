...
typedef NRMKFoundation::SubsysBase<7, 7 - 1, 7 - 1, NRMKFoundation::RigidJoint> Subsys_4AxisArm;

class 4AxisArm : public Subsys_4AxisArm
{
public:
...
public:
	inline 4AxisArm() : Subsys_4AxisArm()
