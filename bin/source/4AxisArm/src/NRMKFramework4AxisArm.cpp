 ...
 */
#include "NRMKFramework4AxisArm.h"
...
const unsigned int SimulationSocket4AxisArm::_bodyIndexArray[] = { 0,1,2,3,4,5,6 };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocket4AxisArm::_dataChannelArray[]
...
const unsigned int DataSocket4AxisArm::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
