 ...
 */
#include "NRMKFrameworkFourAxisArm.h"
...
const unsigned int SimulationSocketFourAxisArm::_bodyIndexArray[] = { 0,1,2,3,4,5,6 };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocketFourAxisArm::_dataChannelArray[]
...
const unsigned int DataSocketFourAxisArm::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
