...
#define NUM_WAYPOINTS				(FourAxisArm::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_FourAxisArm.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_FourAxisArm.dat"
#endif
...
class ControlFourAxisArm
{
public:
	enum
	{
		JOINT_DOF = FourAxisArm::JOINT_DOF,
	};		

	typedef FourAxisArm::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<FourAxisArm> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<FourAxisArm> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<FourAxisArm, TaskKinematics> InverseKinematics;
	
public:
	ControlFourAxisArm();
	~ControlFourAxisArm();

  	FourAxisArm const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	FourAxisArm const & robot() const { return _robot; }
...
private:
	FourAxisArm	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<FourAxisArm, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<FourAxisArm, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
