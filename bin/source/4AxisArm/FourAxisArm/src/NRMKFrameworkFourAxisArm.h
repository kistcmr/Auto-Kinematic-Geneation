...
typedef FourAxisArm			ROBOT;

#if defined(_CONTROLLER)

#if !defined(_APP_MANAGER)
// Control Algorithm
#include "ControlFourAxisArm/ControlFourAxisArm.h"
typedef ControlFourAxisArm		CONTROLLER;
#endif
...
// Simulation Socket
#include "SimulationSocketFourAxisArm.h"
typedef SimulationSocketFourAxisArm SIMULATION_SOCKET;

// Data Socket
#include "DataSocketFourAxisArm.h"
typedef DataSocketFourAxisArm DATA_SOCKET;
...
#if defined(_CONTROL_CLIENT)
// Control graphics 
#include "GraphicsControlFourAxisArm.h"
typedef GraphicsControlFourAxisArm GRAPHICS_CONTROL;
#else	// _CONTROL_CLIENT
// Graphics Socket
#include "GraphicsSocketFourAxisArm.h"
typedef GraphicsSocketFourAxisArm GRAPHICS_SOCKET;
#endif // _CONTROL_CLIENT
