...
const unsigned int SimulationSocketssss::_bodyIndexArray[] = { NRMK_BODY_INDEX };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocketssss::_dataChannelArray[]
...
const unsigned int DataSocketssss::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
