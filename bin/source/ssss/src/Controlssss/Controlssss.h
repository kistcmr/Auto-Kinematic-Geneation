...
#define NUM_WAYPOINTS				(ssss::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_ssss.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_ssss.dat"
#endif
...
public:
	enum
	{
		JOINT_DOF = ssss::JOINT_DOF,
	};		

	typedef ssss::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<ssss> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<ssss> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<ssss, TaskKinematics> InverseKinematics;
	
public:
	Controlssss();
	~Controlssss();

  	ssss const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	ssss const & robot() const { return _robot; }
...
private:
	ssss	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<ssss, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<ssss, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
