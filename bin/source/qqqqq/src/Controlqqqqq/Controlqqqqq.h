...
#define NUM_WAYPOINTS				(qqqqq::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_qqqqq.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_qqqqq.dat"
#endif
...
public:
	enum
	{
		JOINT_DOF = qqqqq::JOINT_DOF,
	};		

	typedef qqqqq::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<qqqqq> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<qqqqq> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<qqqqq, TaskKinematics> InverseKinematics;
	
public:
	Controlqqqqq();
	~Controlqqqqq();

  	qqqqq const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	qqqqq const & robot() const { return _robot; }
...
private:
	qqqqq	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<qqqqq, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<qqqqq, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
