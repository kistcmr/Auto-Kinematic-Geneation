...
// Control Algorithm
#include "Controlqqqqq/Controlqqqqq.h"
typedef Controlqqqqq		CONTROLLER;
#endif
...
// Simulation Socket
#include "SimulationSocketqqqqq.h"
typedef SimulationSocketqqqqq SIMULATION_SOCKET;

// Data Socket
#include "DataSocketqqqqq.h"
typedef DataSocketqqqqq DATA_SOCKET;
...
#if defined(_CONTROL_CLIENT)
// Control graphics 
#include "GraphicsControlqqqqq.h"
typedef GraphicsControlqqqqq GRAPHICS_CONTROL;
#else	// _CONTROL_CLIENT
// Graphics Socket
#include "GraphicsSocketqqqqq.h"
typedef GraphicsSocketqqqqq GRAPHICS_SOCKET;
#endif // _CONTROL_CLIENT
