...
const unsigned int SimulationSocketqqqqq::_bodyIndexArray[] = { NRMK_BODY_INDEX };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocketqqqqq::_dataChannelArray[]
...
const unsigned int DataSocketqqqqq::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
