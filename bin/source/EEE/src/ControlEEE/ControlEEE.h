...
#define NUM_WAYPOINTS				(EEE::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_EEE.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_EEE.dat"
#endif
...
public:
	enum
	{
		JOINT_DOF = EEE::JOINT_DOF,
	};		

	typedef EEE::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<EEE> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<EEE> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<EEE, TaskKinematics> InverseKinematics;
	
public:
	ControlEEE();
	~ControlEEE();

  	EEE const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	EEE const & robot() const { return _robot; }
...
private:
	EEE	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<EEE, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<EEE, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
