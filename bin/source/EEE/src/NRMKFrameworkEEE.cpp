...
const unsigned int SimulationSocketEEE::_bodyIndexArray[] = { NRMK_BODY_INDEX };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocketEEE::_dataChannelArray[]
...
const unsigned int DataSocketEEE::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
