...
// Control Algorithm
#include "ControlEEE/ControlEEE.h"
typedef ControlEEE		CONTROLLER;
#endif
...
// Simulation Socket
#include "SimulationSocketEEE.h"
typedef SimulationSocketEEE SIMULATION_SOCKET;

// Data Socket
#include "DataSocketEEE.h"
typedef DataSocketEEE DATA_SOCKET;
...
#if defined(_CONTROL_CLIENT)
// Control graphics 
#include "GraphicsControlEEE.h"
typedef GraphicsControlEEE GRAPHICS_CONTROL;
#else	// _CONTROL_CLIENT
// Graphics Socket
#include "GraphicsSocketEEE.h"
typedef GraphicsSocketEEE GRAPHICS_SOCKET;
#endif // _CONTROL_CLIENT
