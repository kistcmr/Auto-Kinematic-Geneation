...
const unsigned int SimulationSocketggg::_bodyIndexArray[] = { NRMK_BODY_INDEX };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocketggg::_dataChannelArray[]
...
const unsigned int DataSocketggg::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
