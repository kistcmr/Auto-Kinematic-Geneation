...
// Control Algorithm
#include "Controlggg/Controlggg.h"
typedef Controlggg		CONTROLLER;
#endif
...
// Simulation Socket
#include "SimulationSocketggg.h"
typedef SimulationSocketggg SIMULATION_SOCKET;

// Data Socket
#include "DataSocketggg.h"
typedef DataSocketggg DATA_SOCKET;
...
#if defined(_CONTROL_CLIENT)
// Control graphics 
#include "GraphicsControlggg.h"
typedef GraphicsControlggg GRAPHICS_CONTROL;
#else	// _CONTROL_CLIENT
// Graphics Socket
#include "GraphicsSocketggg.h"
typedef GraphicsSocketggg GRAPHICS_SOCKET;
#endif // _CONTROL_CLIENT
