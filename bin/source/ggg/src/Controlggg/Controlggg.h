...
#define NUM_WAYPOINTS				(ggg::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_ggg.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_ggg.dat"
#endif
...
public:
	enum
	{
		JOINT_DOF = ggg::JOINT_DOF,
	};		

	typedef ggg::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<ggg> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<ggg> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<ggg, TaskKinematics> InverseKinematics;
	
public:
	Controlggg();
	~Controlggg();

  	ggg const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	ggg const & robot() const { return _robot; }
...
private:
	ggg	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<ggg, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<ggg, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
