...
#define NUM_WAYPOINTS				(KKKK::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_KKKK.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_KKKK.dat"
#endif
...
public:
	enum
	{
		JOINT_DOF = KKKK::JOINT_DOF,
	};		

	typedef KKKK::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<KKKK> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<KKKK> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<KKKK, TaskKinematics> InverseKinematics;
	
public:
	ControlKKKK();
	~ControlKKKK();

  	KKKK const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	KKKK const & robot() const { return _robot; }
...
private:
	KKKK	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<KKKK, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<KKKK, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
