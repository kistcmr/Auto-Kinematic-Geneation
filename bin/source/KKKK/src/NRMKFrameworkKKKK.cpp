...
const unsigned int SimulationSocketKKKK::_bodyIndexArray[] = { NRMK_BODY_INDEX };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocketKKKK::_dataChannelArray[]
...
const unsigned int DataSocketKKKK::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
