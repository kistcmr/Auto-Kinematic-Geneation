...
// Control Algorithm
#include "Controlbb/Controlbb.h"
typedef Controlbb		CONTROLLER;
#endif
...
// Simulation Socket
#include "SimulationSocketbb.h"
typedef SimulationSocketbb SIMULATION_SOCKET;

// Data Socket
#include "DataSocketbb.h"
typedef DataSocketbb DATA_SOCKET;
...
#if defined(_CONTROL_CLIENT)
// Control graphics 
#include "GraphicsControlbb.h"
typedef GraphicsControlbb GRAPHICS_CONTROL;
#else	// _CONTROL_CLIENT
// Graphics Socket
#include "GraphicsSocketbb.h"
typedef GraphicsSocketbb GRAPHICS_SOCKET;
#endif // _CONTROL_CLIENT
