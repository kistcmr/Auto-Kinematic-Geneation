...
const unsigned int SimulationSocketbb::_bodyIndexArray[] = { NRMK_BODY_INDEX };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocketbb::_dataChannelArray[]
...
const unsigned int DataSocketbb::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
