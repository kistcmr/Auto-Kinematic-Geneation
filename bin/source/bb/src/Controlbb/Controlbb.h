...
#define NUM_WAYPOINTS				(bb::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_bb.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_bb.dat"
#endif
...
public:
	enum
	{
		JOINT_DOF = bb::JOINT_DOF,
	};		

	typedef bb::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<bb> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<bb> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<bb, TaskKinematics> InverseKinematics;
	
public:
	Controlbb();
	~Controlbb();

  	bb const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	bb const & robot() const { return _robot; }
...
private:
	...
	NRMKFoundation::Waypoint<bb, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<bb, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
