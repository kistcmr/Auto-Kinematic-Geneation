...
// Control Algorithm
#include "Controlvvv/Controlvvv.h"
typedef Controlvvv		CONTROLLER;
#endif
...
// Simulation Socket
#include "SimulationSocketvvv.h"
typedef SimulationSocketvvv SIMULATION_SOCKET;

// Data Socket
#include "DataSocketvvv.h"
typedef DataSocketvvv DATA_SOCKET;
...
#if defined(_CONTROL_CLIENT)
// Control graphics 
#include "GraphicsControlvvv.h"
typedef GraphicsControlvvv GRAPHICS_CONTROL;
#else	// _CONTROL_CLIENT
// Graphics Socket
#include "GraphicsSocketvvv.h"
typedef GraphicsSocketvvv GRAPHICS_SOCKET;
#endif // _CONTROL_CLIENT
