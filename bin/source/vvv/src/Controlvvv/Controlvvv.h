...
#define NUM_WAYPOINTS				(vvv::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_vvv.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_vvv.dat"
#endif
...
public:
	enum
	{
		JOINT_DOF = vvv::JOINT_DOF,
	};		

	typedef vvv::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<vvv> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<vvv> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<vvv, TaskKinematics> InverseKinematics;
	
public:
	Controlvvv();
	~Controlvvv();

  	vvv const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	vvv const & robot() const { return _robot; }
...
private:
	vvv	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<vvv, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<vvv, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
