...
const unsigned int SimulationSocketvvv::_bodyIndexArray[] = { NRMK_BODY_INDEX };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocketvvv::_dataChannelArray[]
...
const unsigned int DataSocketvvv::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
