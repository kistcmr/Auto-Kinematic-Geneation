...
// Control Algorithm
#include "ControlBBB/ControlBBB.h"
typedef ControlBBB		CONTROLLER;
#endif
...
// Simulation Socket
#include "SimulationSocketBBB.h"
typedef SimulationSocketBBB SIMULATION_SOCKET;

// Data Socket
#include "DataSocketBBB.h"
typedef DataSocketBBB DATA_SOCKET;
...
#if defined(_CONTROL_CLIENT)
// Control graphics 
#include "GraphicsControlBBB.h"
typedef GraphicsControlBBB GRAPHICS_CONTROL;
#else	// _CONTROL_CLIENT
// Graphics Socket
#include "GraphicsSocketBBB.h"
typedef GraphicsSocketBBB GRAPHICS_SOCKET;
#endif // _CONTROL_CLIENT
