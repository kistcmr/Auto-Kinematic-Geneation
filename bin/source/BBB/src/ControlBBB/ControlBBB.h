...
#define NUM_WAYPOINTS				(BBB::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_BBB.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_BBB.dat"
#endif
...
public:
	enum
	{
		JOINT_DOF = BBB::JOINT_DOF,
	};		

	typedef BBB::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<BBB> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<BBB> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<BBB, TaskKinematics> InverseKinematics;
	
public:
	ControlBBB();
	~ControlBBB();

  	BBB const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	BBB const & robot() const { return _robot; }
...
private:
	BBB	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<BBB, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<BBB, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
