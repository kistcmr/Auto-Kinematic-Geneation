...
#define NUM_WAYPOINTS				(HHH::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_HHH.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_HHH.dat"
#endif
...
public:
	enum
	{
		JOINT_DOF = HHH::JOINT_DOF,
	};		

	typedef HHH::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<HHH> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<HHH> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<HHH, TaskKinematics> InverseKinematics;
	
public:
	ControlHHH();
	~ControlHHH();

  	HHH const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	HHH const & robot() const { return _robot; }
...
private:
	HHH	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<HHH, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<HHH, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
