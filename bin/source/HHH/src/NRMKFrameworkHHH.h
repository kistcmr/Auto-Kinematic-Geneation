...
// Control Algorithm
#include "ControlHHH/ControlHHH.h"
typedef ControlHHH		CONTROLLER;
#endif
...
// Simulation Socket
#include "SimulationSocketHHH.h"
typedef SimulationSocketHHH SIMULATION_SOCKET;

// Data Socket
#include "DataSocketHHH.h"
typedef DataSocketHHH DATA_SOCKET;
...
#if defined(_CONTROL_CLIENT)
// Control graphics 
#include "GraphicsControlHHH.h"
typedef GraphicsControlHHH GRAPHICS_CONTROL;
#else	// _CONTROL_CLIENT
// Graphics Socket
#include "GraphicsSocketHHH.h"
typedef GraphicsSocketHHH GRAPHICS_SOCKET;
#endif // _CONTROL_CLIENT
