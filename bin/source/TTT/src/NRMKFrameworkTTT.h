...
// Control Algorithm
#include "ControlTTT/ControlTTT.h"
typedef ControlTTT		CONTROLLER;
#endif
...
// Simulation Socket
#include "SimulationSocketTTT.h"
typedef SimulationSocketTTT SIMULATION_SOCKET;

// Data Socket
#include "DataSocketTTT.h"
typedef DataSocketTTT DATA_SOCKET;
...
#if defined(_CONTROL_CLIENT)
// Control graphics 
#include "GraphicsControlTTT.h"
typedef GraphicsControlTTT GRAPHICS_CONTROL;
#else	// _CONTROL_CLIENT
// Graphics Socket
#include "GraphicsSocketTTT.h"
typedef GraphicsSocketTTT GRAPHICS_SOCKET;
#endif // _CONTROL_CLIENT
