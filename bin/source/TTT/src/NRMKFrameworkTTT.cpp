...
const unsigned int SimulationSocketTTT::_bodyIndexArray[] = { NRMK_BODY_INDEX };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocketTTT::_dataChannelArray[]
...
const unsigned int DataSocketTTT::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
