...
#define NUM_WAYPOINTS				(TTT::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_TTT.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_TTT.dat"
#endif
...
public:
	enum
	{
		JOINT_DOF = TTT::JOINT_DOF,
	};		

	typedef TTT::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<TTT> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<TTT> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<TTT, TaskKinematics> InverseKinematics;
	
public:
	ControlTTT();
	~ControlTTT();

  	TTT const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	TTT const & robot() const { return _robot; }
...
private:
	TTT	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<TTT, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<TTT, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
