...
#define NUM_WAYPOINTS				(YYYYY::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_YYYYY.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_YYYYY.dat"
#endif
...
public:
	enum
	{
		JOINT_DOF = YYYYY::JOINT_DOF,
	};		

	typedef YYYYY::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<YYYYY> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<YYYYY> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<YYYYY, TaskKinematics> InverseKinematics;
	
public:
	ControlYYYYY();
	~ControlYYYYY();

  	YYYYY const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	YYYYY const & robot() const { return _robot; }
...
private:
	YYYYY	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<YYYYY, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<YYYYY, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
