...
const unsigned int SimulationSocketYYYYY::_bodyIndexArray[] = { NRMK_BODY_INDEX };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocketYYYYY::_dataChannelArray[]
...
const unsigned int DataSocketYYYYY::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
