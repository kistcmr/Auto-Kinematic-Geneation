...
typedef vvvvvssss			ROBOT;

#if defined(_CONTROLLER)

#if !defined(_APP_MANAGER)
// Control Algorithm
#include "Controlvvvvvssss/Controlvvvvvssss.h"
typedef Controlvvvvvssss		CONTROLLER;
#endif
...
// Simulation Socket
#include "SimulationSocketvvvvvssss.h"
typedef SimulationSocketvvvvvssss SIMULATION_SOCKET;

// Data Socket
#include "DataSocketvvvvvssss.h"
typedef DataSocketvvvvvssss DATA_SOCKET;
...
#if defined(_CONTROL_CLIENT)
// Control graphics 
#include "GraphicsControlvvvvvssss.h"
typedef GraphicsControlvvvvvssss GRAPHICS_CONTROL;
#else	// _CONTROL_CLIENT
// Graphics Socket
#include "GraphicsSocketvvvvvssss.h"
typedef GraphicsSocketvvvvvssss GRAPHICS_SOCKET;
#endif // _CONTROL_CLIENT
