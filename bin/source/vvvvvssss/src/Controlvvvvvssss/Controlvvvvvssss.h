...
#define NUM_WAYPOINTS				(vvvvvssss::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_vvvvvssss.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_vvvvvssss.dat"
#endif
...
class Controlvvvvvssss
{
public:
	enum
	{
		JOINT_DOF = vvvvvssss::JOINT_DOF,
	};		

	typedef vvvvvssss::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<vvvvvssss> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<vvvvvssss> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<vvvvvssss, TaskKinematics> InverseKinematics;
	
public:
	Controlvvvvvssss();
	~Controlvvvvvssss();

  	vvvvvssss const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	vvvvvssss const & robot() const { return _robot; }
...
private:
	vvvvvssss	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<vvvvvssss, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<vvvvvssss, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
