...
typedef NRMKFoundation::SubsysBase<7, 7 - 1, 7 - 1, NRMKFoundation::RigidJoint> Subsys_vvvvvssss;

class vvvvvssss : public Subsys_vvvvvssss
{
public:
...
public:
	inline vvvvvssss() : Subsys_vvvvvssss()
