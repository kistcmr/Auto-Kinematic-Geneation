 ...
 */
#include "NRMKFrameworkvvvvvssss.h"
...
const unsigned int SimulationSocketvvvvvssss::_bodyIndexArray[] = { NRMK_BODY_INDEX };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocketvvvvvssss::_dataChannelArray[]
...
const unsigned int DataSocketvvvvvssss::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
