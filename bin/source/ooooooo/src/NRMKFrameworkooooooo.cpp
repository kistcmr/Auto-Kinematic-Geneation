 ...
 */
#include "NRMKFrameworkooooooo.h"
...
const unsigned int SimulationSocketooooooo::_bodyIndexArray[] = { NRMK_BODY_INDEX };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocketooooooo::_dataChannelArray[]
...
const unsigned int DataSocketooooooo::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
