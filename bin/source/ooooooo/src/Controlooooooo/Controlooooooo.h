...
#define NUM_WAYPOINTS				(ooooooo::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_ooooooo.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_ooooooo.dat"
#endif
...
class Controlooooooo
{
public:
	enum
	{
		JOINT_DOF = ooooooo::JOINT_DOF,
	};		

	typedef ooooooo::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<ooooooo> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<ooooooo> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<ooooooo, TaskKinematics> InverseKinematics;
	
public:
	Controlooooooo();
	~Controlooooooo();

  	ooooooo const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	ooooooo const & robot() const { return _robot; }
...
private:
	ooooooo	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<ooooooo, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<ooooooo, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
