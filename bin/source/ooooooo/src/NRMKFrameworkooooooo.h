...
typedef ooooooo			ROBOT;

#if defined(_CONTROLLER)

#if !defined(_APP_MANAGER)
// Control Algorithm
#include "Controlooooooo/Controlooooooo.h"
typedef Controlooooooo		CONTROLLER;
#endif
...
// Simulation Socket
#include "SimulationSocketooooooo.h"
typedef SimulationSocketooooooo SIMULATION_SOCKET;

// Data Socket
#include "DataSocketooooooo.h"
typedef DataSocketooooooo DATA_SOCKET;
...
#if defined(_CONTROL_CLIENT)
// Control graphics 
#include "GraphicsControlooooooo.h"
typedef GraphicsControlooooooo GRAPHICS_CONTROL;
#else	// _CONTROL_CLIENT
// Graphics Socket
#include "GraphicsSocketooooooo.h"
typedef GraphicsSocketooooooo GRAPHICS_SOCKET;
#endif // _CONTROL_CLIENT
