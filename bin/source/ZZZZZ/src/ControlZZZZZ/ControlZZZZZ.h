...
#define NUM_WAYPOINTS				(ZZZZZ::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_ZZZZZ.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_ZZZZZ.dat"
#endif
...
public:
	enum
	{
		JOINT_DOF = ZZZZZ::JOINT_DOF,
	};		

	typedef ZZZZZ::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<ZZZZZ> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<ZZZZZ> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<ZZZZZ, TaskKinematics> InverseKinematics;
	
public:
	ControlZZZZZ();
	~ControlZZZZZ();

  	ZZZZZ const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	ZZZZZ const & robot() const { return _robot; }
...
private:
	ZZZZZ	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<ZZZZZ, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<ZZZZZ, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
