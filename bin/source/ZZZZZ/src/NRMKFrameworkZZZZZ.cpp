...
const unsigned int SimulationSocketZZZZZ::_bodyIndexArray[] = { NRMK_BODY_INDEX };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocketZZZZZ::_dataChannelArray[]
...
const unsigned int DataSocketZZZZZ::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
