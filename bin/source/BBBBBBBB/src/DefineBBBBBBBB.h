...
typedef NRMKFoundation::SubsysBase<NRMK_NUMBER_OF_BODIES, NRMK_NUMBER_OF_BODIES - 1, NRMK_NUMBER_OF_BODIES - 1, NRMKFoundation::RigidJoint> Subsys_BBBBBBBB;

class BBBBBBBB : public Subsys_BBBBBBBB
{
public:
...
public:
	inline BBBBBBBB() : Subsys_BBBBBBBB()
