 ...
 */
#include "NRMKFrameworkBBBBBBBB.h"
...
const unsigned int SimulationSocketBBBBBBBB::_bodyIndexArray[] = { NRMK_BODY_INDEX };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocketBBBBBBBB::_dataChannelArray[]
...
const unsigned int DataSocketBBBBBBBB::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
