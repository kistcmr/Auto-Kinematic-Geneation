...
#define NUM_WAYPOINTS				(BBBBBBBB::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_BBBBBBBB.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_BBBBBBBB.dat"
#endif
...
class ControlBBBBBBBB
{
public:
	enum
	{
		JOINT_DOF = BBBBBBBB::JOINT_DOF,
	};		

	typedef BBBBBBBB::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<BBBBBBBB> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<BBBBBBBB> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<BBBBBBBB, TaskKinematics> InverseKinematics;
	
public:
	ControlBBBBBBBB();
	~ControlBBBBBBBB();

  	BBBBBBBB const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	BBBBBBBB const & robot() const { return _robot; }
...
private:
	BBBBBBBB	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<BBBBBBBB, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<BBBBBBBB, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
