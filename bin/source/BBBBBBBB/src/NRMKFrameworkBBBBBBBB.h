...
typedef BBBBBBBB			ROBOT;

#if defined(_CONTROLLER)

#if !defined(_APP_MANAGER)
// Control Algorithm
#include "ControlBBBBBBBB/ControlBBBBBBBB.h"
typedef ControlBBBBBBBB		CONTROLLER;
#endif
...
// Simulation Socket
#include "SimulationSocketBBBBBBBB.h"
typedef SimulationSocketBBBBBBBB SIMULATION_SOCKET;

// Data Socket
#include "DataSocketBBBBBBBB.h"
typedef DataSocketBBBBBBBB DATA_SOCKET;
...
#if defined(_CONTROL_CLIENT)
// Control graphics 
#include "GraphicsControlBBBBBBBB.h"
typedef GraphicsControlBBBBBBBB GRAPHICS_CONTROL;
#else	// _CONTROL_CLIENT
// Graphics Socket
#include "GraphicsSocketBBBBBBBB.h"
typedef GraphicsSocketBBBBBBBB GRAPHICS_SOCKET;
#endif // _CONTROL_CLIENT
