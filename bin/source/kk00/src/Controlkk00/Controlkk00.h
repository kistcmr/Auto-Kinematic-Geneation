...
#define NUM_WAYPOINTS				(kk00::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_kk00.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_kk00.dat"
#endif
...
public:
	enum
	{
		JOINT_DOF = kk00::JOINT_DOF,
	};		

	typedef kk00::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<kk00> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<kk00> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<kk00, TaskKinematics> InverseKinematics;
	
public:
	Controlkk00();
	~Controlkk00();

  	kk00 const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	kk00 const & robot() const { return _robot; }
...
private:
	kk00	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<kk00, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<kk00, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
