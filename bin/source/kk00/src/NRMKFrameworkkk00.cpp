...
const unsigned int SimulationSocketkk00::_bodyIndexArray[] = { NRMK_BODY_INDEX };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocketkk00::_dataChannelArray[]
...
const unsigned int DataSocketkk00::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
