...
// Control Algorithm
#include "Controluuu/Controluuu.h"
typedef Controluuu		CONTROLLER;
#endif
...
// Simulation Socket
#include "SimulationSocketuuu.h"
typedef SimulationSocketuuu SIMULATION_SOCKET;

// Data Socket
#include "DataSocketuuu.h"
typedef DataSocketuuu DATA_SOCKET;
...
#if defined(_CONTROL_CLIENT)
// Control graphics 
#include "GraphicsControluuu.h"
typedef GraphicsControluuu GRAPHICS_CONTROL;
#else	// _CONTROL_CLIENT
// Graphics Socket
#include "GraphicsSocketuuu.h"
typedef GraphicsSocketuuu GRAPHICS_SOCKET;
#endif // _CONTROL_CLIENT
