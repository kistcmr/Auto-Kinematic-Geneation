...
const unsigned int SimulationSocketuuu::_bodyIndexArray[] = { NRMK_BODY_INDEX };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocketuuu::_dataChannelArray[]
...
const unsigned int DataSocketuuu::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
