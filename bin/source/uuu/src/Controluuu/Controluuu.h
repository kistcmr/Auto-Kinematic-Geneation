...
#define NUM_WAYPOINTS				(uuu::JOINT_DOF + 1)	// one for initial
...
#ifdef __GNUC__
//#define WAYPOINT_FILE					"_Waypoint_uuu.dat"
#else
//#define WAYPOINT_FILE					"_Waypoint_uuu.dat"
#endif
...
public:
	enum
	{
		JOINT_DOF = uuu::JOINT_DOF,
	};		

	typedef uuu::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<uuu> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<uuu> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<uuu, TaskKinematics> InverseKinematics;
	
public:
	Controluuu();
	~Controluuu();

  	uuu const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	uuu const & robot() const { return _robot; }
...
private:
	uuu	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<uuu, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<uuu, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
