...
typedef NRMKFoundation::SubsysBase<NRMK_NUMBER_OF_BODIES, NRMK_NUMBER_OF_BODIES - 1, NRMK_NUMBER_OF_BODIES - 1, NRMKFoundation::RigidJoint> Subsys_NRMK_ROBOT_NAME;

class NRMK_ROBOT_NAME : public Subsys_NRMK_ROBOT_NAME
{
public:
...
public:
	inline NRMK_ROBOT_NAME() : Subsys_NRMK_ROBOT_NAME()
