 ...
 */
#include "NRMKFrameworkNRMK_ROBOT_NAME.h"
...
const unsigned int SimulationSocketNRMK_ROBOT_NAME::_bodyIndexArray[] = { NRMK_BODY_INDEX };

/// TO DO: Fill in the number of data and the data channel index array
const unsigned int DataSocketNRMK_ROBOT_NAME::_dataChannelArray[]
...
const unsigned int DataSocketNRMK_ROBOT_NAME::_sizeDataChannelArray = sizeof(_dataChannelArray)/sizeof(unsigned int); 
