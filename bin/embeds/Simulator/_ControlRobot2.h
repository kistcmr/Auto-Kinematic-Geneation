...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<NRMK_ROBOT_NAME> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<NRMK_ROBOT_NAME> TaskKinematicsRel;
	...
	typedef NRMKFoundation::CompositeHTransformTaskInterpolator<Interpolator3> TaskInterpolator;
		...
		// Specific to kinematically redundant manipulators
	// Type-definition of extended task variables
	...
	typedef NRMKFoundation::ExtendedTaskAcceleration<TaskKinematics> ExtendedAcceleration;
	typedef NRMKFoundation::ExtendedTaskForce<TaskKinematics> ExtendedForce;

	typedef NRMKFoundation::ExtendedTaskPosition<TaskKinematicsRel> ExtendedPositionRel;
	typedef NRMKFoundation::ExtendedTaskVelocity<TaskKinematicsRel> ExtendedVelocityRel;
	typedef NRMKFoundation::ExtendedTaskAcceleration<TaskKinematicsRel> ExtendedAccelerationRel;
	typedef NRMKFoundation::ExtendedTaskForce<TaskKinematicsRel> ExtendedForceRel;

	// Type-definition of extended task kinematics, controller, and interpolator
	typedef NRMKFoundation::ExtendedTaskKinematics<TaskKinematics> ExtendedKinematics;
	typedef NRMKFoundation::ExtendedTaskController<TaskKinematics, TaskController> ExtendedController;

	typedef NRMKFoundation::ExtendedTaskKinematics<TaskKinematicsRel> ExtendedKinematicsRel;
	typedef NRMKFoundation::ExtendedTaskController<TaskKinematicsRel, TaskController> ExtendedControllerRel;

	// Type-definition of auxiliary data
	typedef ExtendedKinematics::TaskJac ExtendedJacobian;
	typedef ExtendedKinematics::TaskVec ExtendedTaskVec;

	typedef ExtendedKinematicsRel::TaskJac ExtendedJacobianRel;
	typedef ExtendedKinematicsRel::TaskVec ExtendedTaskVecRel;

	typedef NRMKFoundation::NumericInverseKinematics<NRMK_ROBOT_NAME, ExtendedKinematics> InverseKinematics;
...
// Added since v1.6.5
	...
	TaskPosition const & desTask() const { return _pos_des.task; }
	TaskPosition const & targetTask() const { return _pos_target.task; }
...
private:
	...
	ExtendedController _task;
	ExtendedKinematics _tkin;
		
	ExtendedControllerRel _taskRel;
	ExtendedKinematicsRel _tkinRel;
	...
	NRMKFoundation::Waypoint<NRMK_ROBOT_NAME, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<NRMK_ROBOT_NAME, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
	...
	ExtendedPosition _pos_des;
	ExtendedPosition _pos_target;

	ExtendedPositionRel _pos_des_rel;
	ExtendedPositionRel _pos_target_rel;
