...
#define NUM_WAYPOINTS				(Arm3::JOINT_DOF + 1)	// one for initial
...
public:
	...
	typedef Arm3::JointVec JointVec;
...
private:
	...
	typedef NRMKFoundation::CompositeAbsHTransformTaskKinematics<Arm3> TaskKinematics;
	typedef NRMKFoundation::CompositeRelHTransformTaskKinematics<Arm3> TaskKinematicsRel;
	...
	/// FIXME @20160312
	typedef NRMKFoundation::NumericInverseKinematics<Arm3, TaskKinematics> InverseKinematics;
	
public:
	ControlArm3();
	~ControlArm3();

  	Arm3 const & robot() { return _robot;}
...
// Added since v1.6.5
	...
	Arm3 const & robot() const { return _robot; }
...
private:
	Arm3	_robot;						// nominal robot model
	...
	NRMKFoundation::Waypoint<Arm3, TaskKinematics, NUM_WAYPOINTS>	_waypoint;
	NRMKFoundation::Waypoint<Arm3, TaskKinematicsRel, NUM_WAYPOINTS>	_waypointRel;
